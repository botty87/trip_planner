...
// in trip_planner/test/features/discover_new_trips/presentation/cubit/discover_new_trip_stops_cubit_test.dart.
...
import 'package:trip_planner/features/discover_new_trips/domain/usecases/get_public_trip_stops.dart' as _i4;
...
class MockGetPublicTripStops extends _i1.Mock implements _i4.GetPublicTripStops {
  ...
  @override
  _i5.Future<_i3.Either<_i6.DiscoverTripsFailure, List<_i7.TripStop>>> call(_i4.GetPubliTripStopsParams? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [params],
        ...
        returnValueForMissingStub: _i5.Future<_i3.Either<_i6.DiscoverTripsFailure, List<_i7.TripStop>>>.value(
            _FakeEither_1<_i6.DiscoverTripsFailure, List<_i7.TripStop>>(
          this,
          Invocation.method(
            #call,
