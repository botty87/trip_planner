...
import 'package:trip_planner/features/discover_new_trips/data/datasources/discover_trips_data_source.dart' as _i3;
...
class MockDiscoverTripsDataSource extends _i1.Mock implements _i3.DiscoverTripsDataSource {
  @override
  _i4.Future<List<_i5.Trip>> getPublicTrips(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #getPublicTrips,
          [userId],
        ),
        returnValue: _i4.Future<List<_i5.Trip>>.value(<_i5.Trip>[]),
        returnValueForMissingStub: _i4.Future<List<_i5.Trip>>.value(<_i5.Trip>[]),
      ) as _i4.Future<List<_i5.Trip>>);

  @override
  _i4.Future<List<_i6.DayTrip>> getPublicDayTrips(String? tripId) => (super.noSuchMethod(
        Invocation.method(
          #getPublicDayTrips,
          [tripId],
        ),
        returnValue: _i4.Future<List<_i6.DayTrip>>.value(<_i6.DayTrip>[]),
        returnValueForMissingStub: _i4.Future<List<_i6.DayTrip>>.value(<_i6.DayTrip>[]),
  ...
  _i4.Future<List<_i7.TripStop>> getPublicTripStops(
    ...
    String? dayTripId,
      ...
      (super.noSuchMethod(
        ...
        returnValueForMissingStub: _i4.Future<List<_i7.TripStop>>.value(<_i7.TripStop>[]),
...
class MockFirebaseCrashlytics extends _i1.Mock implements _i8.FirebaseCrashlytics {
  ...
  @override
  _i4.Future<void> recordFlutterFatalError(_i9.FlutterErrorDetails? flutterErrorDetails) => (super.noSuchMethod(
        Invocation.method(
