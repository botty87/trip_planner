...
import 'package:trip_planner/features/settings/domain/entities/settings.dart' as _i6;
import 'package:trip_planner/features/settings/domain/entities/view_preferences.dart' as _i8;
import 'package:trip_planner/features/settings/domain/usecases/update_view_preferences.dart' as _i9;
import 'package:trip_planner/features/tutorials/domain/entities/tutorials_data.dart' as _i7;
import 'package:trip_planner/features/user_account/data/datasources/user_data_source.dart' as _i3;
import 'package:trip_planner/features/user_account/data/models/user_model.dart' as _i5;
...
class MockUserDataSource extends _i1.Mock implements _i3.UserDataSource {
  ...
  @override
  dynamic saveTutorialsData(_i7.TutorialsData? tutorialsData) => super.noSuchMethod(
        Invocation.method(
          #saveTutorialsData,
          [tutorialsData],
        ),
  ...
  @override
  _i4.Future<Map<String, String>> getUsersNames(List<String>? userIds) => (super.noSuchMethod(
        Invocation.method(
          #getUsersNames,
          [userIds],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockFirebaseCrashlytics extends _i1.Mock implements _i10.FirebaseCrashlytics {
  @override
  ...
  @override
  _i4.Future<void> recordFlutterFatalError(_i11.FlutterErrorDetails? flutterErrorDetails) => (super.noSuchMethod(
        Invocation.method(
