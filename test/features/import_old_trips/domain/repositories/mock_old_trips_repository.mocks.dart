...
import 'package:trip_planner/features/import_old_trips/domain/entities/trip_stops_container.dart' as _i9;
import 'package:trip_planner/features/import_old_trips/domain/repositories/old_trips_repository.dart' as _i3;
...
class MockOldTripsRepository extends _i1.Mock implements _i3.OldTripsRepository {
  @override
  _i4.Future<_i2.Either<_i5.ImportOldTripsFailure, List<_i6.OldTrip>>> readOldTrips({required String? userId}) =>
      (super.noSuchMethod(
        Invocation.method(
          #readOldTrips,
          [],
