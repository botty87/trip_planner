...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/add_trip_stop.svg.vec
  String get addTripStopSvg => 'assets/svg/add_trip_stop.svg.vec';
  ...
  /// File path: assets/svg/no_trips.svg.vec
  String get noTripsSvg => 'assets/svg/no_trips.svg.vec';
...
class $AssetsTutorialGen {
  ...
  AssetGenImage get dayTripsPage => const AssetGenImage('assets/tutorial/day_trips_page.webp');

  /// File path: assets/tutorial/trip_stops_page.webp
  AssetGenImage get tripStopsPage => const AssetGenImage('assets/tutorial/trip_stops_page.webp');

  /// File path: assets/tutorial/trips_page.webp
  AssetGenImage get tripsPage => const AssetGenImage('assets/tutorial/trips_page.webp');

  /// File path: assets/tutorial/tutorial_end_page.webp
  AssetGenImage get tutorialEndPage => const AssetGenImage('assets/tutorial/tutorial_end_page.webp');

  /// List of all assets
  List<AssetGenImage> get values => [dayTripsPage, tripStopsPage, tripsPage, tutorialEndPage];
}
