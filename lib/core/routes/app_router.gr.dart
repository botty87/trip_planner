...
abstract class $AppRouter extends _i18.RootStackRouter {
  ...
  final Map<String, _i18.PageFactory> pagesMap = {
    ...
    InfoContactsRoute.name: (routeData) {
      return _i18.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i3.InfoContactsPage(),
      );
    },
    ...
    DiscoverNewDailyTripsRoute.name: (routeData) {
      ...
      return _i18.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i14.DiscoverNewDailyTripsPage(
          key: args.key,
          trip: args.trip,
        ),
      );
    ...
    DiscoverNewTripStopRoute.name: (routeData) {
      ...
      return _i18.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i15.DiscoverNewTripStopPage(
          key: args.key,
          tripStop: args.tripStop,
        ),
      );
    ...
    DiscoverNewTripsRoute.name: (routeData) {
      return _i18.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i16.DiscoverNewTripsPage(),
      );
    },
    DiscoverNewTripStopsRoute.name: (routeData) {
      ...
      return _i18.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i17.DiscoverNewTripStopsPage(
          key: args.key,
          trip: args.trip,
          dayTrip: args.dayTrip,
        ),
...
/// generated route for
/// [_i14.DiscoverNewDailyTripsPage]
