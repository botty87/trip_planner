...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i33.FetchSuggestions>(
        () => _i33.FetchSuggestions(gh<_i11.GooglePlacesRepository>()));
    gh.factory<_i34.GooglePlacesCubit>(() =>
        _i34.GooglePlacesCubit(fetchSuggestions: gh<_i33.FetchSuggestions>()));
    gh.lazySingleton<_i35.ListenTrips>(
        () => _i35.ListenTrips(gh<_i17.TripsRepository>()));
    gh.lazySingleton<_i36.ListenUser>(
        () => _i36.ListenUser(gh<_i23.UserRepository>()));
    gh.lazySingleton<_i37.LoginUser>(
        () => _i37.LoginUser(gh<_i23.UserRepository>()));
    gh.factoryParam<_i38.NewDayTripCubit, String, dynamic>((
      tripId,
      _,
    ) =>
        _i38.NewDayTripCubit(
          createDayTrip: gh<_i27.CreateDayTrip>(),
          tripId: tripId,
        ));
    gh.lazySingleton<_i39.RecoverPassword>(
        () => _i39.RecoverPassword(gh<_i23.UserRepository>()));
    gh.lazySingleton<_i40.RegisterUser>(
        () => _i40.RegisterUser(gh<_i23.UserRepository>()));
    gh.factoryParam<_i41.TripCubit, _i30.Trip, dynamic>((
      trip,
      _,
    ) =>
        _i41.TripCubit(
...
class _$Network extends _i46.Network {}
