...
import '../../features/day_trips/data/repositories/day_trips_repository_impl.dart'
    as _i6;
import '../../features/day_trips/domain/entities/day_trip.dart' as _i52;
...
import '../../features/trip_stops/domain/usecases/listen_trip_stops.dart'
    as _i39;
import '../../features/trip_stops/domain/usecases/trip_stop_done.dart' as _i49;
...
import '../../features/trips/data/repositories/trips_repository_impl.dart'
    as _i17;
import '../../features/trips/domain/entities/trip.dart' as _i48;
...
import '../../features/trips/presentation/cubit/new_trip/new_trip_cubit.dart'
    as _i57;
import '../../features/trips/presentation/cubit/trip/trip_cubit.dart' as _i47;
import '../../features/trips/presentation/cubit/trips/trips_cubit.dart' as _i59;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factoryParam<_i43.NewDayTripCubit, String, dynamic>((
      tripId,
      _,
    ) =>
        _i43.NewDayTripCubit(
    ...
    gh.lazySingleton<_i45.RecoverPassword>(
        () => _i45.RecoverPassword(gh<_i27.UserRepository>()));
    gh.lazySingleton<_i46.RegisterUser>(
        () => _i46.RegisterUser(gh<_i27.UserRepository>()));
    gh.factoryParam<_i47.TripCubit, _i48.Trip, dynamic>((
      trip,
      _,
    ) =>
        _i47.TripCubit(
    ...
    gh.lazySingleton<_i49.TripStopDone>(
        () => _i49.TripStopDone(gh<_i13.TripStopsRepository>()));
    gh.lazySingleton<_i50.UserCubit>(
        () => _i50.UserCubit(listenUserState: gh<_i41.ListenUser>()));
    gh.factoryParam<_i51.DayTripCubit, _i48.Trip, _i52.DayTrip>((
      trip,
      dayTrip,
    ) =>
        _i51.DayTripCubit(
    ...
    gh.lazySingleton<_i53.FetchPlaceDetails>(
        () => _i53.FetchPlaceDetails(gh<_i37.GooglePlacesRepository>()));
    gh.lazySingleton<_i54.FetchSuggestions>(
        () => _i54.FetchSuggestions(gh<_i37.GooglePlacesRepository>()));
    gh.factory<_i55.GooglePlacesCubit>(() => _i55.GooglePlacesCubit(
          fetchSuggestions: gh<_i54.FetchSuggestions>(),
          fetchPlaceDetails: gh<_i53.FetchPlaceDetails>(),
        ));
    gh.factory<_i56.LoginSignupCubit>(() => _i56.LoginSignupCubit(
          registerUser: gh<_i46.RegisterUser>(),
          loginUser: gh<_i42.LoginUser>(),
          recoverPassword: gh<_i45.RecoverPassword>(),
        ));
    gh.factory<_i57.NewTripCubit>(() => _i57.NewTripCubit(
          gh<_i50.UserCubit>(),
          gh<_i32.CreateTrip>(),
        ));
    gh.factoryParam<_i58.TripStopCubit, _i58.TripStopCubitParams, dynamic>((
      params,
      _,
    ) =>
        _i58.TripStopCubit(
          params: params,
          tripStopDone: gh<_i49.TripStopDone>(),
          updateTripStopNote: gh<_i24.UpdateTripStopNote>(),
          deleteTripStop: gh<_i35.DeleteTripStop>(),
          updateTripStop: gh<_i23.UpdateTripStop>(),
        ));
    gh.factory<_i59.TripsCubit>(() => _i59.TripsCubit(
          gh<_i40.ListenTrips>(),
          gh<_i50.UserCubit>(),
        ));
    return this;
...
class _$Network extends _i60.Network {}
