...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i9.RegisterUser>(
        () => _i9.RegisterUser(gh<_i5.UserRepository>()));
    gh.lazySingleton<_i10.UserCubit>(
        () => _i10.UserCubit(listenUserState: gh<_i7.ListenUser>()));
    gh.factory<_i11.LoginSignupCubit>(
        () => _i11.LoginSignupCubit(gh<_i9.RegisterUser>()));
    return this;
  }
}
