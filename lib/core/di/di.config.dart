...
import '../../features/day_trips/data/repositories/day_trips_repository_impl.dart'
    as _i59;
import '../../features/day_trips/domain/entities/day_trip.dart' as _i98;
import '../../features/day_trips/domain/repositories/day_trips_repository.dart'
    as _i58;
import '../../features/day_trips/domain/usecases/create_day_trip.dart' as _i95;
...
import '../../features/trips/data/repositories/trips_repository_impl.dart'
    as _i38;
import '../../features/trips/domain/entities/trip.dart' as _i97;
...
import '../../features/trips/presentation/cubit/new_trip/new_trip_cubit.dart'
    as _i105;
import '../../features/trips/presentation/cubit/trip/trip_cubit.dart' as _i108;
...
import '../../features/user_account/data/repositories/user_repository_impl.dart'
    as _i47;
import '../../features/user_account/domain/entities/user.dart' as _i44;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i44.User>(() => userModule.user);
    ...
    gh.factory<_i50.BackgroundsCubit>(() => _i50.BackgroundsCubit(
    ...
    gh.lazySingleton<_i53.CreateFromExistingTrip>(
        () => _i53.CreateFromExistingTrip(gh<_i37.TripsRepository>()));
    gh.lazySingleton<_i54.CreateTrip>(
        () => _i54.CreateTrip(gh<_i37.TripsRepository>()));
    gh.lazySingleton<_i55.CreateTripStop>(
        () => _i55.CreateTripStop(gh<_i33.TripStopsRepository>()));
    ...
    gh.lazySingleton<_i61.DeleteTrip>(
        () => _i61.DeleteTrip(gh<_i37.TripsRepository>()));
    gh.lazySingleton<_i62.DeleteTripStop>(
        () => _i62.DeleteTripStop(gh<_i33.TripStopsRepository>()));
    ...
    gh.factory<_i66.DiscoverNewTripsCubit>(() => _i66.DiscoverNewTripsCubit(
    ...
    gh.factoryParam<_i71.ImportOldTripsCubit, _i44.User, dynamic>((
      user,
      _,
    ) =>
    ...
    gh.lazySingleton<_i72.ListenDayTrip>(
        () => _i72.ListenDayTrip(gh<_i58.DayTripsRepository>()));
    gh.lazySingleton<_i73.ListenDayTrips>(
        () => _i73.ListenDayTrips(gh<_i58.DayTripsRepository>()));
    ...
    gh.lazySingleton<_i76.ListenUser>(
        () => _i76.ListenUser(gh<_i46.UserRepository>()));
    gh.lazySingleton<_i77.LoginUser>(
        () => _i77.LoginUser(gh<_i46.UserRepository>()));
    gh.lazySingleton<_i78.LogoutUser>(
        () => _i78.LogoutUser(gh<_i46.UserRepository>()));
    gh.lazySingleton<_i79.ReauthenticateUser>(
        () => _i79.ReauthenticateUser(gh<_i46.UserRepository>()));
    gh.lazySingleton<_i80.RecoverPassword>(
        () => _i80.RecoverPassword(gh<_i46.UserRepository>()));
    gh.lazySingleton<_i81.RegisterUser>(
        () => _i81.RegisterUser(gh<_i46.UserRepository>()));
    gh.lazySingleton<_i82.SaveTripStopsDirections>(
        () => _i82.SaveTripStopsDirections(gh<_i58.DayTripsRepository>()));
    gh.lazySingleton<_i83.TripStopDone>(
        () => _i83.TripStopDone(gh<_i33.TripStopsRepository>()));
    gh.factory<_i84.TripsCubit>(() => _i84.TripsCubit(
          listenTrips: gh<_i75.ListenTrips>(),
          crashlytics: gh<_i11.FirebaseCrashlytics>(),
          user: gh<_i44.User>(),
        ));
    gh.lazySingleton<_i85.UpdateDayTrip>(
        () => _i85.UpdateDayTrip(gh<_i58.DayTripsRepository>()));
    gh.lazySingleton<_i86.UpdateDayTripShowDirections>(
        () => _i86.UpdateDayTripShowDirections(gh<_i58.DayTripsRepository>()));
    gh.lazySingleton<_i87.UpdateDayTripStartTime>(
        () => _i87.UpdateDayTripStartTime(gh<_i58.DayTripsRepository>()));
    ...
    gh.lazySingleton<_i89.UpdateDayTripsIndexes>(
        () => _i89.UpdateDayTripsIndexes(gh<_i58.DayTripsRepository>()));
    gh.lazySingleton<_i90.UpdateSettings>(
        () => _i90.UpdateSettings(gh<_i46.UserRepository>()));
    gh.lazySingleton<_i91.UpdateTripStopsDirectionsUpToDate>(() =>
        _i91.UpdateTripStopsDirectionsUpToDate(gh<_i58.DayTripsRepository>()));
    gh.lazySingleton<_i92.UpdateUserDetails>(
        () => _i92.UpdateUserDetails(gh<_i46.UserRepository>()));
    gh.lazySingleton<_i93.UserCubit>(
        () => _i93.UserCubit(listenUserState: gh<_i76.ListenUser>()));
    gh.factoryParam<_i94.AccountCubit, dynamic, dynamic>((
      user,
      _,
    ) =>
        _i94.AccountCubit(
    ...
    gh.lazySingleton<_i95.CreateDayTrip>(
        () => _i95.CreateDayTrip(gh<_i58.DayTripsRepository>()));
    gh.factoryParam<_i96.DayTripCubit, _i97.Trip, _i98.DayTrip>((
      trip,
      dayTrip,
    ) =>
        _i96.DayTripCubit(
    ...
    gh.lazySingleton<_i99.FetchPlaceDetails>(
        () => _i99.FetchPlaceDetails(gh<_i68.GooglePlacesRepository>()));
    gh.lazySingleton<_i100.FetchSuggestions>(
        () => _i100.FetchSuggestions(gh<_i68.GooglePlacesRepository>()));
    gh.lazySingleton<_i101.FetchTripStopsDirections>(() =>
        _i101.FetchTripStopsDirections(gh<_i68.GooglePlacesRepository>()));
    gh.factory<_i102.GooglePlacesCubit>(() => _i102.GooglePlacesCubit(
          fetchSuggestions: gh<_i100.FetchSuggestions>(),
          fetchPlaceDetails: gh<_i99.FetchPlaceDetails>(),
        ));
    gh.factory<_i103.LoginSignupCubit>(() => _i103.LoginSignupCubit(
          registerUser: gh<_i81.RegisterUser>(),
          loginUser: gh<_i77.LoginUser>(),
          recoverPassword: gh<_i80.RecoverPassword>(),
        ));
    gh.factoryParam<_i104.NewDayTripCubit, String, dynamic>((
      tripId,
      _,
    ) =>
        _i104.NewDayTripCubit(
          createDayTrip: gh<_i95.CreateDayTrip>(),
          settings: gh<_i29.Settings>(),
          tripId: tripId,
        ));
    gh.factoryParam<_i105.NewTripCubit, _i97.Trip?, dynamic>((
      existingTrip,
      _,
    ) =>
        _i105.NewTripCubit(
          userCubit: gh<_i93.UserCubit>(),
          createTrip: gh<_i54.CreateTrip>(),
          createFromExistingTrip: gh<_i53.CreateFromExistingTrip>(),
          settings: gh<_i29.Settings>(),
          existingTrip: existingTrip,
        ));
    gh.factoryParam<_i106.NewTripStopCubit, String, String>((
      tripId,
      dayTripId,
    ) =>
        _i106.NewTripStopCubit(
          tripId: tripId,
          dayTripId: dayTripId,
    ...
    gh.lazySingleton<_i107.SettingsCubit>(() => _i107.SettingsCubit(
          updateSettings: gh<_i90.UpdateSettings>(),
          userCubit: gh<_i93.UserCubit>(),
        ));
    gh.factoryParam<_i108.TripCubit, _i97.Trip, dynamic>((
      trip,
      _,
    ) =>
        _i108.TripCubit(
    ...
    gh.factoryParam<_i109.TripStopCubit, _i109.TripStopCubitParams, dynamic>((
      params,
      _,
    ) =>
        _i109.TripStopCubit(
    ...
    gh.factoryParam<_i110.TripStopsMapCubit, _i97.Trip, _i98.DayTrip>((
      trip,
      dayTrip,
    ) =>
        _i110.TripStopsMapCubit(
          fetchPolylinePoints: gh<_i101.FetchTripStopsDirections>(),
...
class _$Network extends _i111.Network {}

class _$FirebaseModule extends _i111.FirebaseModule {}

class _$RegisterModule extends _i111.RegisterModule {}

class _$GooglePlacesModule extends _i111.GooglePlacesModule {}

class _$SettingsModule extends _i107.SettingsModule {}

class _$UserModule extends _i93.UserModule {}
