...
import 'package:internet_connection_checker_plus/internet_connection_checker_plus.dart' as _i8;
import 'package:logger/logger.dart' as _i9;

import '../../features/day_trips/data/datasources/day_trips_data_source.dart' as _i28;
import '../../features/day_trips/data/repositories/day_trips_repository_impl.dart' as _i30;
import '../../features/day_trips/domain/entities/day_trip.dart' as _i58;
import '../../features/day_trips/domain/repositories/day_trips_repository.dart' as _i29;
...
import '../../features/day_trips/domain/usecases/update_day_trip_start_time.dart' as _i50;
import '../../features/day_trips/domain/usecases/update_day_trips_indexes.dart' as _i51;
import '../../features/day_trips/presentation/cubit/day_trip/cubit/day_trip_cubit.dart' as _i56;
import '../../features/day_trips/presentation/cubit/new_day_trip/new_day_trip_cubit.dart' as _i63;
import '../../features/google_places/data/datasources/google_places_data_source.dart' as _i35;
import '../../features/google_places/data/repositories/google_places_repository_impl.dart' as _i37;
import '../../features/google_places/domain/repositories/google_places_repository.dart' as _i36;
import '../../features/google_places/domain/usecases/fetch_place_details.dart' as _i59;
import '../../features/google_places/domain/usecases/fetch_suggestions.dart' as _i60;
import '../../features/google_places/presentation/cubit/google_places_cubit.dart' as _i61;
import '../../features/trip_stops/data/datasources/trip_stops_data_source.dart' as _i10;
import '../../features/trip_stops/data/repositories/trip_stops_repository_impl.dart' as _i12;
import '../../features/trip_stops/domain/repositories/trip_stops_repository.dart' as _i11;
import '../../features/trip_stops/domain/usecases/create_trip_stop.dart' as _i27;
import '../../features/trip_stops/domain/usecases/delete_trip_stop.dart' as _i33;
import '../../features/trip_stops/domain/usecases/listen_trip_stops.dart' as _i39;
import '../../features/trip_stops/domain/usecases/trip_stop_done.dart' as _i48;
import '../../features/trip_stops/domain/usecases/update_travel_time.dart' as _i16;
import '../../features/trip_stops/domain/usecases/update_trip_stop.dart' as _i18;
import '../../features/trip_stops/domain/usecases/update_trip_stop_note.dart' as _i19;
import '../../features/trip_stops/domain/usecases/update_trip_stops_indexes.dart' as _i20;
import '../../features/trip_stops/presentation/cubit/new_trip_stop/new_trip_stop_cubit.dart'
    as _i44;
import '../../features/trip_stops/presentation/cubit/trip_stop/trip_stop_cubit.dart' as _i66;
import '../../features/trips/data/datasources/trips_data_source.dart' as _i13;
import '../../features/trips/data/repositories/trips_repository_impl.dart' as _i15;
...
import '../../features/trips/presentation/cubit/new_trip/new_trip_cubit.dart' as _i64;
...
import '../../features/user_account/data/datasources/user_data_source.dart' as _i21;
import '../../features/user_account/data/repositories/user_repository_impl.dart' as _i23;
import '../../features/user_account/domain/repositories/user_repository.dart' as _i22;
...
import '../../features/user_account/domain/usecases/reauthenticate_user.dart' as _i45;
import '../../features/user_account/domain/usecases/recover_password.dart' as _i46;
import '../../features/user_account/domain/usecases/register_user.dart' as _i47;
import '../../features/user_account/domain/usecases/update_user_details.dart' as _i52;
import '../../features/user_account/presentation/cubit/account_page/account_cubit.dart' as _i54;
import '../../features/user_account/presentation/cubit/login_signup/login_signup_cubit.dart'
    as _i62;
import '../../features/user_account/presentation/cubit/user/user_cubit.dart' as _i53;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i6.FirebaseCrashlytics>(() => firebaseModule.firebaseCrashlytics);
    gh.lazySingleton<_i7.FirebaseFirestore>(() => firebaseModule.firebaseFirestore);
    ...
    gh.lazySingleton<_i17.UpdateTrip>(() => _i17.UpdateTrip(gh<_i14.TripsRepository>()));
    ...
    gh.lazySingleton<_i22.UserRepository>(() => _i23.UserRepositoryImpl(gh<_i21.UserDataSource>()));
    gh.lazySingleton<_i24.BlocObserver>(() => _i25.SimpleBlocObserver(logger: gh<_i9.Logger>()));
    gh.lazySingleton<_i26.CreateTrip>(() => _i26.CreateTrip(gh<_i14.TripsRepository>()));
    ...
    gh.lazySingleton<_i31.DeleteDayTrip>(() => _i31.DeleteDayTrip(gh<_i29.DayTripsRepository>()));
    gh.lazySingleton<_i32.DeleteTrip>(() => _i32.DeleteTrip(gh<_i14.TripsRepository>()));
    ...
    gh.lazySingleton<_i35.GooglePlacesDataSource>(() => _i35.GooglePlacesDataSourceImpl(
          gh<_i4.Dio>(),
          gh<_i8.InternetConnection>(),
        ));
    gh.lazySingleton<_i36.GooglePlacesRepository>(
        () => _i37.GooglePlacesRepositoryImpl(gh<_i35.GooglePlacesDataSource>()));
    gh.lazySingleton<_i38.ListenDayTrips>(() => _i38.ListenDayTrips(gh<_i29.DayTripsRepository>()));
    gh.lazySingleton<_i39.ListenTripStops>(
        () => _i39.ListenTripStops(gh<_i11.TripStopsRepository>()));
    gh.lazySingleton<_i40.ListenTrips>(() => _i40.ListenTrips(gh<_i14.TripsRepository>()));
    gh.lazySingleton<_i41.ListenUser>(() => _i41.ListenUser(gh<_i22.UserRepository>()));
    gh.lazySingleton<_i42.LoginUser>(() => _i42.LoginUser(gh<_i22.UserRepository>()));
    gh.lazySingleton<_i43.LogoutUser>(() => _i43.LogoutUser(gh<_i22.UserRepository>()));
    ...
    gh.lazySingleton<_i46.RecoverPassword>(() => _i46.RecoverPassword(gh<_i22.UserRepository>()));
    gh.lazySingleton<_i47.RegisterUser>(() => _i47.RegisterUser(gh<_i22.UserRepository>()));
    gh.lazySingleton<_i48.TripStopDone>(() => _i48.TripStopDone(gh<_i11.TripStopsRepository>()));
    gh.lazySingleton<_i49.UpdateDayTrip>(() => _i49.UpdateDayTrip(gh<_i29.DayTripsRepository>()));
    ...
    gh.lazySingleton<_i53.UserCubit>(() => _i53.UserCubit(listenUserState: gh<_i41.ListenUser>()));
    ...
    gh.lazySingleton<_i55.CreateDayTrip>(() => _i55.CreateDayTrip(gh<_i29.DayTripsRepository>()));
