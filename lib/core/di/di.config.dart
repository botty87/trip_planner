...
import 'package:trip_planner/core/di/di.dart' as _i39;
...
import 'package:trip_planner/features/trips/data/repositories/trips_repository_impl.dart'
    as _i13;
import 'package:trip_planner/features/trips/domain/entities/trip.dart' as _i25;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factoryParam<_i10.NewTripStopCubit, String, String>((
      tripId,
      dayTripId,
    ) =>
        _i10.NewTripStopCubit(
          tripId: tripId,
          dayTripId: dayTripId,
        ));
    gh.lazySingleton<_i11.TripsDataSource>(() => _i11.TripsDataSourceImpl());
    gh.lazySingleton<_i12.TripsRepository>(() =>
        _i13.TripsRepositoryImpl(tripsDataSource: gh<_i11.TripsDataSource>()));
    gh.lazySingleton<_i14.UpdateDayTrip>(
        () => _i14.UpdateDayTrip(gh<_i5.DayTripsRepository>()));
    gh.lazySingleton<_i15.UpdateDayTripsIndexes>(
        () => _i15.UpdateDayTripsIndexes(gh<_i5.DayTripsRepository>()));
    gh.lazySingleton<_i16.UpdateTrip>(
        () => _i16.UpdateTrip(gh<_i12.TripsRepository>()));
    ...
    gh.lazySingleton<_i20.BlocObserver>(
        () => _i21.SimpleBlocObserver(logger: gh<_i9.Logger>()));
    gh.lazySingleton<_i22.CreateDayTrip>(
        () => _i22.CreateDayTrip(gh<_i5.DayTripsRepository>()));
    gh.lazySingleton<_i23.CreateTrip>(
        () => _i23.CreateTrip(gh<_i12.TripsRepository>()));
    gh.factoryParam<_i24.DayTripCubit, _i25.Trip, _i26.DayTrip>((
      trip,
      dayTrip,
    ) =>
        _i24.DayTripCubit(
          trip: trip,
          dayTrip: dayTrip,
          updateDayTrip: gh<_i14.UpdateDayTrip>(),
          deleteDayTrip: gh<_i7.DeleteDayTrip>(),
        ));
    gh.lazySingleton<_i27.DeleteTrip>(
        () => _i27.DeleteTrip(gh<_i12.TripsRepository>()));
    gh.lazySingleton<_i28.ListenTrips>(
        () => _i28.ListenTrips(gh<_i12.TripsRepository>()));
    gh.lazySingleton<_i29.ListenUser>(
        () => _i29.ListenUser(gh<_i18.UserRepository>()));
    gh.lazySingleton<_i30.LoginUser>(
        () => _i30.LoginUser(gh<_i18.UserRepository>()));
    gh.factoryParam<_i31.NewDayTripCubit, String, dynamic>((
      tripId,
      _,
    ) =>
        _i31.NewDayTripCubit(
          createDayTrip: gh<_i22.CreateDayTrip>(),
          tripId: tripId,
        ));
    gh.lazySingleton<_i32.RecoverPassword>(
        () => _i32.RecoverPassword(gh<_i18.UserRepository>()));
    gh.lazySingleton<_i33.RegisterUser>(
        () => _i33.RegisterUser(gh<_i18.UserRepository>()));
    gh.factoryParam<_i34.TripCubit, _i25.Trip, dynamic>((
      trip,
      _,
    ) =>
        _i34.TripCubit(
    ...
    gh.lazySingleton<_i35.UserCubit>(
        () => _i35.UserCubit(listenUserState: gh<_i29.ListenUser>()));
    gh.factory<_i36.LoginSignupCubit>(() => _i36.LoginSignupCubit(
          registerUser: gh<_i33.RegisterUser>(),
          loginUser: gh<_i30.LoginUser>(),
          recoverPassword: gh<_i32.RecoverPassword>(),
        ));
    gh.factory<_i37.NewTripCubit>(() => _i37.NewTripCubit(
          gh<_i35.UserCubit>(),
          gh<_i23.CreateTrip>(),
        ));
    gh.factory<_i38.TripsCubit>(() => _i38.TripsCubit(
          gh<_i28.ListenTrips>(),
          gh<_i35.UserCubit>(),
        ));
    return this;
