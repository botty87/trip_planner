...
import 'package:trip_planner/core/bloc_observer.dart' as _i16;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i12.UserDataSource>(() => _i12.UserDataSourceImpl());
    gh.lazySingleton<_i13.UserRepository>(
        () => _i14.UserRepositoryImpl(gh<_i12.UserDataSource>()));
    gh.lazySingleton<_i15.BlocObserver>(
        () => _i16.SimpleBlocObserver(logger: gh<_i8.Logger>()));
    gh.lazySingleton<_i17.CreateDayTrip>(
        () => _i17.CreateDayTrip(gh<_i5.DayTripsRepository>()));
    gh.lazySingleton<_i18.CreateTrip>(
        () => _i18.CreateTrip(gh<_i10.TripsRepository>()));
    gh.lazySingleton<_i19.DeleteTrip>(
        () => _i19.DeleteTrip(gh<_i10.TripsRepository>()));
    gh.lazySingleton<_i20.ListenTrips>(
        () => _i20.ListenTrips(gh<_i10.TripsRepository>()));
    gh.lazySingleton<_i21.ListenUser>(
        () => _i21.ListenUser(gh<_i13.UserRepository>()));
    gh.lazySingleton<_i22.LoginUser>(
        () => _i22.LoginUser(gh<_i13.UserRepository>()));
    gh.factoryParam<_i23.NewDayTripCubit, String, dynamic>((
      tripId,
      _,
    ) =>
        _i23.NewDayTripCubit(
          createDayTrip: gh<_i17.CreateDayTrip>(),
          tripId: tripId,
        ));
    gh.lazySingleton<_i24.RecoverPassword>(
        () => _i24.RecoverPassword(gh<_i13.UserRepository>()));
    gh.lazySingleton<_i25.RegisterUser>(
        () => _i25.RegisterUser(gh<_i13.UserRepository>()));
    gh.lazySingleton<_i26.SaveTrip>(
        () => _i26.SaveTrip(gh<_i10.TripsRepository>()));
    gh.factoryParam<_i27.TripCubit, _i28.Trip, dynamic>((
      ...
      _,
        ...
        _i27.TripCubit(
          trip: trip,
          saveTrip: gh<_i26.SaveTrip>(),
          deleteTrip: gh<_i19.DeleteTrip>(),
          listenDayTrips: gh<_i7.ListenDayTrips>(),
        ));
    gh.lazySingleton<_i29.UserCubit>(
        () => _i29.UserCubit(listenUserState: gh<_i21.ListenUser>()));
    gh.factory<_i30.LoginSignupCubit>(() => _i30.LoginSignupCubit(
          registerUser: gh<_i25.RegisterUser>(),
          loginUser: gh<_i22.LoginUser>(),
          recoverPassword: gh<_i24.RecoverPassword>(),
        ));
