...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i50.BackgroundsCubit>(() =>
    ...
    gh.lazySingleton<_i92.UpdateTutorialsData>(
        () => _i92.UpdateTutorialsData(gh<_i46.UserRepository>()));
    gh.lazySingleton<_i93.UpdateUserDetails>(
        () => _i93.UpdateUserDetails(gh<_i46.UserRepository>()));
    ...
    gh.lazySingleton<_i96.CreateDayTrip>(
        () => _i96.CreateDayTrip(gh<_i58.DayTripsRepository>()));
    ...
    gh.lazySingleton<_i100.FetchPlaceDetails>(
        () => _i100.FetchPlaceDetails(gh<_i68.GooglePlacesRepository>()));
    gh.lazySingleton<_i101.FetchSuggestions>(
        () => _i101.FetchSuggestions(gh<_i68.GooglePlacesRepository>()));
    gh.lazySingleton<_i102.FetchTripStopsDirections>(() =>
        _i102.FetchTripStopsDirections(gh<_i68.GooglePlacesRepository>()));
    ...
    gh.lazySingleton<_i108.SettingsCubit>(() => _i108.SettingsCubit(
    ...
    gh.lazySingleton<_i112.TutorialCubit>(() => _i112.TutorialCubit(
          user: gh<_i44.User>(),
          hideShowWelcome: gh<_i92.UpdateTutorialsData>(),
        ));
    return this;
  }
}
...
class _$UserModule extends _i94.UserModule {}
