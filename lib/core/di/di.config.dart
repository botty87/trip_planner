...
import 'package:trip_planner/core/bloc_observer.dart' as _i18;
import 'package:trip_planner/core/di/di.dart' as _i34;
...
import 'package:trip_planner/features/trips/data/repositories/trips_repository_impl.dart'
    as _i11;
import 'package:trip_planner/features/trips/domain/entities/trip.dart' as _i29;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i12.UpdateDayTripsIndexes>(
        () => _i12.UpdateDayTripsIndexes(gh<_i5.DayTripsRepository>()));
    gh.lazySingleton<_i13.UpdateTrip>(
        () => _i13.UpdateTrip(gh<_i10.TripsRepository>()));
    gh.lazySingleton<_i14.UserDataSource>(() => _i14.UserDataSourceImpl());
    gh.lazySingleton<_i15.UserRepository>(
        () => _i16.UserRepositoryImpl(gh<_i14.UserDataSource>()));
    gh.lazySingleton<_i17.BlocObserver>(
        () => _i18.SimpleBlocObserver(logger: gh<_i8.Logger>()));
    gh.lazySingleton<_i19.CreateDayTrip>(
        () => _i19.CreateDayTrip(gh<_i5.DayTripsRepository>()));
    gh.lazySingleton<_i20.CreateTrip>(
        () => _i20.CreateTrip(gh<_i10.TripsRepository>()));
    gh.lazySingleton<_i21.DeleteTrip>(
        () => _i21.DeleteTrip(gh<_i10.TripsRepository>()));
    gh.lazySingleton<_i22.ListenTrips>(
        () => _i22.ListenTrips(gh<_i10.TripsRepository>()));
    gh.lazySingleton<_i23.ListenUser>(
        () => _i23.ListenUser(gh<_i15.UserRepository>()));
    gh.lazySingleton<_i24.LoginUser>(
        () => _i24.LoginUser(gh<_i15.UserRepository>()));
    gh.factoryParam<_i25.NewDayTripCubit, String, dynamic>((
      tripId,
      _,
    ) =>
        _i25.NewDayTripCubit(
          createDayTrip: gh<_i19.CreateDayTrip>(),
          tripId: tripId,
        ));
    gh.lazySingleton<_i26.RecoverPassword>(
        () => _i26.RecoverPassword(gh<_i15.UserRepository>()));
    gh.lazySingleton<_i27.RegisterUser>(
        () => _i27.RegisterUser(gh<_i15.UserRepository>()));
    gh.factoryParam<_i28.TripCubit, _i29.Trip, dynamic>((
      trip,
      _,
    ) =>
        _i28.TripCubit(
          trip: trip,
          saveTrip: gh<_i13.UpdateTrip>(),
          deleteTrip: gh<_i21.DeleteTrip>(),
          listenDayTrips: gh<_i7.ListenDayTrips>(),
          updateDayTripsIndexes: gh<_i12.UpdateDayTripsIndexes>(),
        ));
    gh.lazySingleton<_i30.UserCubit>(
        () => _i30.UserCubit(listenUserState: gh<_i23.ListenUser>()));
    gh.factory<_i31.LoginSignupCubit>(() => _i31.LoginSignupCubit(
          registerUser: gh<_i27.RegisterUser>(),
          loginUser: gh<_i24.LoginUser>(),
          recoverPassword: gh<_i26.RecoverPassword>(),
        ));
    gh.factory<_i32.NewTripCubit>(() => _i32.NewTripCubit(
          gh<_i30.UserCubit>(),
          gh<_i20.CreateTrip>(),
        ));
    gh.factory<_i33.TripsCubit>(() => _i33.TripsCubit(
          gh<_i22.ListenTrips>(),
          gh<_i30.UserCubit>(),
        ));
    return this;
