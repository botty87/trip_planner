...
part of 'info_contacts_cubit.dart';
...
/// @nodoc
class _$InfoContactsStateCopyWithImpl<$Res, $Val extends InfoContactsState>
    implements $InfoContactsStateCopyWith<$Res> {
  _$InfoContactsStateCopyWithImpl(this._value, this._then);
...
class _$InfoContactsStateImpl implements _InfoContactsState {
  const _$InfoContactsStateImpl();

  @override
  String toString() {
    return 'InfoContactsState()';
  }
...
abstract class _InfoContactsState implements InfoContactsState {
  const factory _InfoContactsState() = _$InfoContactsStateImpl;
}
