...
mixin _$NewTripStopState {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(String? name, String? description, int hourDuration,
            int minuteDuration, LatLng? location)
        normal,
    required TResult Function(
            String name, String? description, int hourDuration, int minuteDuration, LatLng location)
        saving,
    required TResult Function(
            String name, String? description, int hourDuration, int minuteDuration, LatLng location)
        created,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(String? name, String? description, int hourDuration, int minuteDuration,
            LatLng? location)?
        normal,
    TResult? Function(String name, String? description, int hourDuration, int minuteDuration,
            LatLng location)?
    ...
    TResult? Function(String name, String? description, int hourDuration, int minuteDuration,
        ...
        created,
    TResult? Function(String? name, String? description, int hourDuration, int minuteDuration,
            LatLng? location, String errorMessage)?
        error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$NewTripStopStateNormalImpl implements NewTripStopStateNormal {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, description, hourDuration, minuteDuration, location);
...
class _$NewTripStopStateErrorImpl implements NewTripStopStateError {
  ...
  int get hashCode => Object.hash(
      runtimeType, name, description, hourDuration, minuteDuration, location, errorMessage);
