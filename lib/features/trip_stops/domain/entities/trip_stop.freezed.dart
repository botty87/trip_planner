...
mixin _$TripStop {
  ...
  String? get description => throw _privateConstructorUsedError; //Duration of the stop in minutes
  int get duration => throw _privateConstructorUsedError;
  @JsonKey(toJson: geoPointFromLatLng, fromJson: latLngFromGeoPoint)
  LatLng get location => throw _privateConstructorUsedError;
  bool get isDone => throw _privateConstructorUsedError;
  int get travelTimeToNextStop => throw _privateConstructorUsedError; // in minutes
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  $TripStopCopyWith<TripStop> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TripStopCopyWith<$Res> {
  factory $TripStopCopyWith(TripStop value, $Res Function(TripStop) then) = _$TripStopCopyWithImpl<$Res, TripStop>;
  @useResult
  $Res call(
      ...
      String? description,
      int duration,
      @JsonKey(toJson: geoPointFromLatLng, fromJson: latLngFromGeoPoint) LatLng location,
      bool isDone,
...
/// @nodoc
class _$TripStopCopyWithImpl<$Res, $Val extends TripStop> implements $TripStopCopyWith<$Res> {
...
/// @nodoc
abstract class _$$TripStopImplCopyWith<$Res> implements $TripStopCopyWith<$Res> {
  factory _$$TripStopImplCopyWith(_$TripStopImpl value, $Res Function(_$TripStopImpl) then) =
...
/// @nodoc
class __$$TripStopImplCopyWithImpl<$Res> extends _$TripStopCopyWithImpl<$Res, _$TripStopImpl>
    implements _$$TripStopImplCopyWith<$Res> {
  __$$TripStopImplCopyWithImpl(_$TripStopImpl _value, $Res Function(_$TripStopImpl) _then) : super(_value, _then);
...
class _$TripStopImpl implements _TripStop {
  const _$TripStopImpl(
      ...
      @JsonKey(toJson: geoPointFromLatLng, fromJson: latLngFromGeoPoint) required this.location,
      this.isDone = false,
      this.travelTimeToNextStop = 0,
      this.note,
      this.placeholder});

  factory _$TripStopImpl.fromJson(Map<String, dynamic> json) => _$$TripStopImplFromJson(json);
...
// in minutes
  ...
  int get hashCode => Object.hash(
      runtimeType, id, index, name, description, duration, location, isDone, travelTimeToNextStop, note, placeholder);
...
abstract class _TripStop implements TripStop {
  const factory _TripStop(
      ...
      @JsonKey(toJson: geoPointFromLatLng, fromJson: latLngFromGeoPoint) required final LatLng location,
      final bool isDone,
      final int travelTimeToNextStop,
      final String? note,
      final TripStopPlaceholder? placeholder}) = _$TripStopImpl;

  factory _TripStop.fromJson(Map<String, dynamic> json) = _$TripStopImpl.fromJson;
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  _$$TripStopImplCopyWith<_$TripStopImpl> get copyWith => throw _privateConstructorUsedError;
}
...
mixin _$TripStopPlaceholder {
  ...
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $TripStopPlaceholderCopyWith<TripStopPlaceholder> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TripStopPlaceholderCopyWith<$Res> {
  factory $TripStopPlaceholderCopyWith(TripStopPlaceholder value, $Res Function(TripStopPlaceholder) then) =
...
/// @nodoc
abstract class _$$TripStopPlaceholderImplCopyWith<$Res> implements $TripStopPlaceholderCopyWith<$Res> {
  factory _$$TripStopPlaceholderImplCopyWith(
          _$TripStopPlaceholderImpl value, $Res Function(_$TripStopPlaceholderImpl) then) =
...
class __$$TripStopPlaceholderImplCopyWithImpl<$Res>
  ...
  __$$TripStopPlaceholderImplCopyWithImpl(
      _$TripStopPlaceholderImpl _value, $Res Function(_$TripStopPlaceholderImpl) _then)
      : super(_value, _then);
...
class _$TripStopPlaceholderImpl implements _TripStopPlaceholder {
  ...
  factory _$TripStopPlaceholderImpl.fromJson(Map<String, dynamic> json) => _$$TripStopPlaceholderImplFromJson(json);
  ...
  _$$TripStopPlaceholderImplCopyWith<_$TripStopPlaceholderImpl> get copyWith =>
      __$$TripStopPlaceholderImplCopyWithImpl<_$TripStopPlaceholderImpl>(this, _$identity);
...
abstract class _TripStopPlaceholder implements TripStopPlaceholder {
  const factory _TripStopPlaceholder({required final String name, required final int duration}) =
      _$TripStopPlaceholderImpl;

  factory _TripStopPlaceholder.fromJson(Map<String, dynamic> json) = _$TripStopPlaceholderImpl.fromJson;
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  _$$TripStopPlaceholderImplCopyWith<_$TripStopPlaceholderImpl> get copyWith => throw _privateConstructorUsedError;
}
