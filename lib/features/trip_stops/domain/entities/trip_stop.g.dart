...
_$TripStopImpl _$$TripStopImplFromJson(Map<String, dynamic> json) => _$TripStopImpl(
      ...
      travelTimeToNextStop: (json['travelTimeToNextStop'] as num?)?.toInt() ?? 0,
      note: json['note'] as String?,
      placeholder: json['placeholder'] == null
          ? null
          : TripStopPlaceholder.fromJson(json['placeholder'] as Map<String, dynamic>),
    );
...
_$TripStopPlaceholderImpl _$$TripStopPlaceholderImplFromJson(Map<String, dynamic> json) => _$TripStopPlaceholderImpl(
      name: json['name'] as String,
      duration: (json['duration'] as num).toInt(),
    );

Map<String, dynamic> _$$TripStopPlaceholderImplToJson(_$TripStopPlaceholderImpl instance) => <String, dynamic>{
      'name': instance.name,
      'duration': instance.duration,
    };
