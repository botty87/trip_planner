...
_$UserModelImpl _$$UserModelImplFromJson(Map<String, dynamic> json) => _$UserModelImpl(
      ...
      settings:
          json['settings'] == null ? const Settings() : Settings.fromJson(json['settings'] as Map<String, dynamic>),
      ...
      viewPreferences: json['viewPreferences'] == null
          ...
          : ViewPreferences.fromJson(json['viewPreferences'] as Map<String, dynamic>),
    );
