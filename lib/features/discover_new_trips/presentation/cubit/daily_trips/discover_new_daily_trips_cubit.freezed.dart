...
/// @nodoc
mixin _$DiscoverNewDailyTripsState {
  @optionalTypeArgs
...
class _$StateInitialImpl implements StateInitial {
  ...
  @override
  String toString() {
    return 'DiscoverNewDailyTripsState.initial()';
  }
...
class _$StateErrorImpl implements StateError {
  ...
  @override
  String toString() {
    return 'DiscoverNewDailyTripsState.error(message: $message)';
  }
...
abstract class StateError implements DiscoverNewDailyTripsState {
